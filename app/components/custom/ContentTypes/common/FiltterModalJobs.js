...
const FilterModalJobs = (props) => {
	const { filterWrapperReducer ,jobList} = useSelector((state) => state);
	...
	return (
		<View style={{ alignItems: 'center' }}>
			{jobList.refreshStatus == true ? null :
				<FlatList
					ref={(ref) => {
...
export default FilterModalJobs;
